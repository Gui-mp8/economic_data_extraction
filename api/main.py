...
# def main():
    ...
    BigQuery(config).parquet_to_bigquery(dataset_name="economic_data", table_name="bloomberg")
    ...
    BigQuery(config).parquet_to_bigquery(dataset_name="economic_data", table_name="usc_cny")
    ...
    BigQuery(config).parquet_to_bigquery(dataset_name="economic_data", table_name="china_index")
